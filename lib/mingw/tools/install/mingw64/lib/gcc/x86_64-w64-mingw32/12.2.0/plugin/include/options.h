...
enum opt_code
{
  ...
  OPT_Wpedantic_ms_format = 701,             /* -Wpedantic-ms-format */
  ...
  OPT_Wtrivial_auto_var_init = 794,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 795,                           /* -Wtsan */
  OPT_Wtype_limits = 796,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 797,            /* -Wundeclared-selector */
  OPT_Wundef = 798,                          /* -Wundef */
  OPT_Wundefined_do_loop = 799,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 800,                      /* -Wunderflow */
  OPT_Wuninitialized = 801,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 802,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 803, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 804, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 805,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 806,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 807,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 808,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 809, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 810,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 811,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 812,                /* -Wunused-function */
  OPT_Wunused_label = 813,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 814,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 815,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 816,               /* -Wunused-parameter */
  OPT_Wunused_result = 817,                  /* -Wunused-result */
  OPT_Wunused_value = 818,                   /* -Wunused-value */
  OPT_Wunused_variable = 819,                /* -Wunused-variable */
  OPT_Wuse_after_free = 820,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 821,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 822,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 823,                   /* -Wuseless-cast */
  OPT_Wvarargs = 824,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 825,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 826,   /* -Wvector-operation-performance */
  OPT_Wvexing_parse = 827,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 828,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 829,            /* -Wvirtual-move-assign */
  OPT_Wvla = 830,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 831,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 832,                  /* -Wvla-parameter */
  OPT_Wvolatile = 833,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 834,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 835,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 836,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 837,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 838,                       /* -Wzerotrip */
  OPT_X = 839,                               /* -X */
  OPT_Xassembler = 840,                      /* -Xassembler */
  OPT_Xf = 841,                              /* -Xf */
  OPT_Xlinker = 842,                         /* -Xlinker */
  OPT_Xpreprocessor = 843,                   /* -Xpreprocessor */
  OPT_Z = 844,                               /* -Z */
  OPT_ansi = 845,                            /* -ansi */
  OPT_aux_info = 846,                        /* -aux-info */
  /* OPT_aux_info_ = 847, */                 /* -aux-info= */
  OPT_c = 848,                               /* -c */
  OPT_callgraph = 849,                       /* -callgraph */
  OPT_coverage = 850,                        /* -coverage */
  OPT_cpp = 851,                             /* -cpp */
  OPT_cpp_ = 852,                            /* -cpp= */
  OPT_d = 853,                               /* -d */
  OPT_debuglib_ = 854,                       /* -debuglib= */
  OPT_defaultlib_ = 855,                     /* -defaultlib= */
  OPT_defined_only = 856,                    /* -defined-only */
  OPT_demangle = 857,                        /* -demangle */
  OPT_dstartfiles = 858,                     /* -dstartfiles */
  OPT_dump_body_ = 859,                      /* -dump-body= */
  OPT_dump_level_ = 860,                     /* -dump-level= */
  OPT_dumpbase = 861,                        /* -dumpbase */
  OPT_dumpbase_ext = 862,                    /* -dumpbase-ext */
  OPT_dumpdir = 863,                         /* -dumpdir */
  OPT_dumpfullversion = 864,                 /* -dumpfullversion */
  OPT_dumpmachine = 865,                     /* -dumpmachine */
  OPT_dumpspecs = 866,                       /* -dumpspecs */
  OPT_dumpversion = 867,                     /* -dumpversion */
  OPT_e = 868,                               /* -e */
  OPT_export_dynamic = 869,                  /* -export-dynamic */
  OPT_fPIC = 870,                            /* -fPIC */
  OPT_fPIE = 871,                            /* -fPIE */
  OPT_fRTS_ = 872,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 873,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 874,                   /* -fabi-version= */
  OPT_faccess_control = 875,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 876,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 877,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 878,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 879,                  /* -falign-commons */
  OPT_falign_functions = 880,                /* -falign-functions */
  OPT_falign_functions_ = 881,               /* -falign-functions= */
  OPT_falign_jumps = 882,                    /* -falign-jumps */
  OPT_falign_jumps_ = 883,                   /* -falign-jumps= */
  OPT_falign_labels = 884,                   /* -falign-labels */
  OPT_falign_labels_ = 885,                  /* -falign-labels= */
  OPT_falign_loops = 886,                    /* -falign-loops */
  OPT_falign_loops_ = 887,                   /* -falign-loops= */
  /* OPT_faligned_new = 888, */              /* -faligned-new */
  OPT_faligned_new_ = 889,                   /* -faligned-new= */
  OPT_fall_instantiations = 890,             /* -fall-instantiations */
  OPT_fall_intrinsics = 891,                 /* -fall-intrinsics */
  OPT_fall_virtual = 892,                    /* -fall-virtual */
  OPT_fallocation_dce = 893,                 /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 894,        /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 895,              /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 896,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 897,/* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 898,         /* -fallow-store-data-races */
  OPT_falt_external_templates = 899,         /* -falt-external-templates */
  OPT_fanalyzer = 900,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 901,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 902,              /* -fanalyzer-checker= */
  OPT_fanalyzer_feasibility = 903,           /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 904,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 905,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_state_merge = 906,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 907,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_transitivity = 908,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_verbose_edges = 909,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 910, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 911,            /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 912, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 913, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 914, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 915, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 916,            /* -fasan-shadow-offset= */
  OPT_fasm = 917,                            /* -fasm */
  OPT_fassert = 918,                         /* -fassert */
  OPT_fassociative_math = 919,               /* -fassociative-math */
  OPT_fasynchronous_unwind_tables = 920,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 921,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 922,                   /* -fauto-profile */
  OPT_fauto_profile_ = 923,                  /* -fauto-profile= */
  OPT_fautomatic = 924,                      /* -fautomatic */
  OPT_fbackslash = 925,                      /* -fbackslash */
  OPT_fbacktrace = 926,                      /* -fbacktrace */
  OPT_fbit_tests = 927,                      /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 928,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 929,                   /* -fbounds-check */
  OPT_fbounds_check_ = 930,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 931,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 932,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 933, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 934, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 935, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 936,                /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 937,           /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 938,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 939,                        /* -fbuiltin */
  OPT_fbuiltin_ = 940,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 941,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 942,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 943,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 944,                    /* -fcall-saved- */
  OPT_fcall_used_ = 945,                     /* -fcall-used- */
  OPT_fcaller_saves = 946,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 947,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 948,                /* -fcallgraph-info= */
  OPT_fcanonical_system_headers = 949,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 950, */            /* -fcf-protection */
  OPT_fcf_protection_ = 951,                 /* -fcf-protection= */
  OPT_fchar8_t = 952,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 953,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 954, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 955,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 956,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 957,                         /* -fcheck= */
  /* OPT_fcheck_assert = 958, */             /* -fcheck=assert */
  /* OPT_fcheck_bounds = 959, */             /* -fcheck=bounds */
  /* OPT_fcheck_in = 960, */                 /* -fcheck=in */
  /* OPT_fcheck_invariant = 961, */          /* -fcheck=invariant */
  /* OPT_fcheck_out = 962, */                /* -fcheck=out */
  /* OPT_fcheck_switch = 963, */             /* -fcheck=switch */
  OPT_fcheckaction_ = 964,                   /* -fcheckaction= */
  OPT_fchecking = 965,                       /* -fchecking */
  OPT_fchecking_ = 966,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 967,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 968,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 969,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 970,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 971,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 972,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 973,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 974,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 975, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 976,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 977,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 978,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 979, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 980,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 981,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 982,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 983,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 984,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 985, */                 /* -fcilkplus */
  OPT_fcoarray_ = 986,                       /* -fcoarray= */
  OPT_fcode_hoisting = 987,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 988,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 989,                         /* -fcommon */
  OPT_fcompare_debug = 990,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 991,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 992,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 993,                   /* -fcompare-elim */
  OPT_fconcepts = 994,                       /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 995,    /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 996,                    /* -fconcepts-ts */
  OPT_fcond_mismatch = 997,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 998, */           /* -fconserve-space */
  OPT_fconserve_stack = 999,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1000,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1001,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1002,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1003,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1004,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1005,          /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 1006,                      /* -fconvert= */
  OPT_fcoroutines = 1007,                    /* -fcoroutines */
  OPT_fcprop_registers = 1008,               /* -fcprop-registers */
  OPT_fcray_pointer = 1009,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1010,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1011,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1012, */         /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 1013,              /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 1014,              /* -fcx-limited-range */
  OPT_fd_lines_as_code = 1015,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1016,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1017,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1018,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1019,                      /* -fdbg-cnt= */
  OPT_fdce = 1020,                           /* -fdce */
  OPT_fdebug = 1021,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1022,                /* -fdebug-aux-vars */
  OPT_fdebug_cpp = 1023,                     /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 1024,             /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 1025,           /* -fdebug-types-section */
  OPT_fdebug_ = 1026,                        /* -fdebug= */
  OPT_fdec = 1027,                           /* -fdec */
  OPT_fdec_blank_format_item = 1028,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1029,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1030,           /* -fdec-format-defaults */
  OPT_fdec_include = 1031,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1032,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1033,                      /* -fdec-math */
  OPT_fdec_static = 1034,                    /* -fdec-static */
  OPT_fdec_structure = 1035,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1036,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1037, */        /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 1038,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1039, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1040,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1041,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1042,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1043,                /* -fdefault-real-8 */
  OPT_fdefer_pop = 1044,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1045,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1046,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1047,    /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 1048,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1049,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1050,    /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 1051, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1052,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1053,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1054,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1055,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1056,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1057,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 1058,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1059,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1060,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1061,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_show_caret = 1062,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1063,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 1064,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1065, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1066,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1067,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1068,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_template_tree = 1069,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 1070,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1071,               /* -fdirectives-only */
  OPT_fdisable_ = 1072,                      /* -fdisable- */
  OPT_fdoc = 1073,                           /* -fdoc */
  OPT_fdoc_dir_ = 1074,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1075,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1076,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1077,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1078,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1079,                      /* -fdruntime */
  OPT_fdse = 1080,                           /* -fdse */
  OPT_fdump_ = 1081,                         /* -fdump- */
  OPT_fdump_ada_spec = 1082,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1083,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1084,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1085,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1086,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1087,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1088,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1089,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1090,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1091,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_json = 1092,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1093,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1094,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1095,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1096,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1097,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1098,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1099, */               /* -fdump-core */
  OPT_fdump_d_original = 1100,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1101,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1102,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1103,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1104,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1105,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1106,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1107,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1108,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1109, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1110,                   /* -fdump-passes */
  OPT_fdump_scos = 1111,                     /* -fdump-scos */
  OPT_fdump_unnumbered = 1112,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1113,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1114,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1115,                /* -fearly-inlining */
  OPT_felide_constructors = 1116,            /* -felide-constructors */
  OPT_felide_type = 1117,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1118, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1119,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1120,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1121,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1122,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1123,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1124,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1125,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1126,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1127,                /* -fenum-int-equiv */
  OPT_fexceptions = 1128,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1129,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1130,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1131,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1132,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1133,          /* -fextended-identifiers */
  OPT_fextern_std_ = 1134,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1135,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1136,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1137,            /* -fexternal-templates */
  OPT_ff2c = 1138,                           /* -ff2c */
  OPT_ffast_math = 1139,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1140,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1141,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1142,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1143,              /* -ffinite-math-only */
  OPT_ffixed_ = 1144,                        /* -ffixed- */
  OPT_ffixed_form = 1145,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1146,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1147,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1148,                   /* -ffloat-store */
  OPT_ffold_simple_inlines = 1149,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1150,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1151, */              /* -fforce-addr */
  OPT_fforward_propagate = 1152,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1153,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1154,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1155,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1156,                     /* -ffpe-trap= */
  OPT_ffree_form = 1157,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1158,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1159,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1160,                  /* -ffreestanding */
  OPT_ffriend_injection = 1161,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1162,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1163,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1164,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1165,             /* -ffunction-sections */
  OPT_fgcse = 1166,                          /* -fgcse */
  OPT_fgcse_after_reload = 1167,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1168,                      /* -fgcse-las */
  OPT_fgcse_lm = 1169,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1170,                       /* -fgcse-sm */
  OPT_fgimple = 1171,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1172,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1173,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1174,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1175,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1176,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1177,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1178,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1179,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1180,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1181,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1182,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1183,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1184,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1185,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1186,                  /* -fgo-embedcfg= */
  OPT_fgo_optimize_ = 1187,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1188,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1189,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1190,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1191,                      /* -fgraphite */
  OPT_fgraphite_identity = 1192,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1193,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1194,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1195, */       /* -fhandle-exceptions */
  OPT_fharden_compares = 1196,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1197,   /* -fharden-conditional-branches */
  /* OPT_fhelp = 1198, */                    /* -fhelp */
  /* OPT_fhelp_ = 1199, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1200,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1201,                     /* -fhonor-std */
  OPT_fhosted = 1202,                        /* -fhosted */
  OPT_fhuge_objects = 1203,                  /* -fhuge-objects */
  OPT_fident = 1204,                         /* -fident */
  OPT_fif_conversion = 1205,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1206,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1207,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1208,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1209,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1210,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1211,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1212,            /* -fimplicit-templates */
  OPT_findirect_inlining = 1213,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1214,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1215,               /* -finit-character= */
  OPT_finit_derived = 1216,                  /* -finit-derived */
  OPT_finit_integer_ = 1217,                 /* -finit-integer= */
  OPT_finit_local_zero = 1218,               /* -finit-local-zero */
  OPT_finit_logical_ = 1219,                 /* -finit-logical= */
  OPT_finit_real_ = 1220,                    /* -finit-real= */
  OPT_finline = 1221,                        /* -finline */
  OPT_finline_arg_packing = 1222,            /* -finline-arg-packing */
  OPT_finline_atomics = 1223,                /* -finline-atomics */
  OPT_finline_functions = 1224,              /* -finline-functions */
  OPT_finline_functions_called_once = 1225,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1226, */           /* -finline-limit- */
  OPT_finline_limit_ = 1227,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1228,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1229,        /* -finline-small-functions */
  OPT_finput_charset_ = 1230,                /* -finput-charset= */
  OPT_finstrument_functions = 1231,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1232,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1233,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 1234,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1235,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1236,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1237,                    /* -finvariants */
  OPT_fipa_bit_cp = 1238,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1239,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1240, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1241,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1242,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1243,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1244,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1245, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1246,                    /* -fipa-modref */
  OPT_fipa_profile = 1247,                   /* -fipa-profile */
  OPT_fipa_pta = 1248,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1249,                /* -fipa-pure-const */
  OPT_fipa_ra = 1250,                        /* -fipa-ra */
  OPT_fipa_reference = 1251,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1252,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1253,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1254,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1255,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1256, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1257,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1258,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1259,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1260,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1261,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1262,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1263,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1264,                  /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 1265,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1266,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1267,              /* -fivar-visibility= */
  OPT_fivopts = 1268,                        /* -fivopts */
  OPT_fjump_tables = 1269,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1270,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1271,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1272,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1273,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1274,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1275,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1276,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1277,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1278,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1279,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1280,         /* -flang-info-module-cmi= */
  OPT_flarge_source_files = 1281,            /* -flarge-source-files */
  OPT_flax_vector_conversions = 1282,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1283,            /* -fleading-underscore */
  OPT_flifetime_dse = 1284,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1285,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1286,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1287,                /* -flinker-output= */
  /* OPT_flive_patching = 1288, */           /* -flive-patching */
  OPT_flive_patching_ = 1289,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1290,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1291,                   /* -flocal-ivars */
  /* OPT_floop_block = 1292, */              /* -floop-block */
  /* OPT_floop_flatten = 1293, */            /* -floop-flatten */
  OPT_floop_interchange = 1294,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1295,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1296, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1297,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1298, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1299,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1300,                     /* -flra-remat */
  OPT_flto = 1301,                           /* -flto */
  OPT_flto_compression_level_ = 1302,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1303, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1304,                /* -flto-partition= */
  OPT_flto_report = 1305,                    /* -flto-report */
  OPT_flto_report_wpa = 1306,                /* -flto-report-wpa */
  OPT_flto_ = 1307,                          /* -flto= */
  OPT_fltrans = 1308,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1309,           /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 1310,             /* -fmacro-prefix-map= */
  OPT_fmain = 1311,                          /* -fmain */
  OPT_fmath_errno = 1312,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1313,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1314,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1315,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1316,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1317,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1318,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1319,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1320,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1321,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1322,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1323,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1324,               /* -fmessage-length= */
  OPT_fmodule_file_ = 1325,                  /* -fmodule-file= */
  OPT_fmodule_header = 1326,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1327,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1328,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1329,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1330,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1331,                   /* -fmodule-only */
  OPT_fmodule_private = 1332,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1333,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1334,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1335,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1336,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1337,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1338,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1339,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1340,                 /* -fms-extensions */
  OPT_fmudflap = 1341,                       /* -fmudflap */
  OPT_fmudflapir = 1342,                     /* -fmudflapir */
  OPT_fmudflapth = 1343,                     /* -fmudflapth */
  OPT_fname_mangling_version_ = 1344,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1345,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1346,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1347,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1348,                  /* -fnext-runtime */
  OPT_fnil_receivers = 1349,                 /* -fnil-receivers */
  OPT_fno_modules = 1350,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1351,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1352,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1353,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1354,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1355,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1356,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1357,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1358,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1359,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1360,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1361,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1362,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1363,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1364,              /* -foffload-options= */
  OPT_foffload_ = 1365,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1366,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1367,                         /* -fonly= */
  OPT_fopenacc = 1368,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1369,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1370,                        /* -fopenmp */
  OPT_fopenmp_simd = 1371,                   /* -fopenmp-simd */
  OPT_foperator_names = 1372,                /* -foperator-names */
  OPT_fopt_info = 1373,                      /* -fopt-info */
  OPT_fopt_info_ = 1374,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1375, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1376,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1377,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1378, */          /* -foptional-diags */
  OPT_fpack_derived = 1379,                  /* -fpack-derived */
  OPT_fpack_struct = 1380,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1381,                  /* -fpack-struct= */
  OPT_fpad_source = 1382,                    /* -fpad-source */
  OPT_fpartial_inlining = 1383,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1384,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1385,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1386,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1387,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1388,                    /* -fpeel-loops */
  OPT_fpeephole = 1389,                      /* -fpeephole */
  OPT_fpeephole2 = 1390,                     /* -fpeephole2 */
  OPT_fpermissive = 1391,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1392,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1393,                           /* -fpic */
  OPT_fpie = 1394,                           /* -fpie */
  OPT_fplan9_extensions = 1395,              /* -fplan9-extensions */
  OPT_fplt = 1396,                           /* -fplt */
  OPT_fplugin_arg_ = 1397,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1398,                       /* -fplugin= */
  OPT_fpost_ipa_mem_report = 1399,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1400,                /* -fpostconditions */
  OPT_fpre_include_ = 1401,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1402,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1403,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1404,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1405,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1406,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1407,              /* -fpretty-templates */
  OPT_fpreview_all = 1408,                   /* -fpreview=all */
  OPT_fpreview_dip1000 = 1409,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1410,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1411,               /* -fpreview=dip1021 */
  OPT_fpreview_dip25 = 1412,                 /* -fpreview=dip25 */
  OPT_fpreview_dtorfields = 1413,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1414,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1415,          /* -fpreview=fixaliasthis */
  OPT_fpreview_in = 1416,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1417,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1418,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1419,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_shortenedmethods = 1420,      /* -fpreview=shortenedmethods */
  OPT_fprintf_return_value = 1421,           /* -fprintf-return-value */
  OPT_fprofile = 1422,                       /* -fprofile */
  OPT_fprofile_abs_path = 1423,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1424,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1425,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1426,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1427,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1428,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1429,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1430,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1431,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1432,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1433,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1434,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1435,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1436,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1437,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1438,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1439,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1440,               /* -fprofile-update= */
  OPT_fprofile_use = 1441,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1442,                  /* -fprofile-use= */
  OPT_fprofile_values = 1443,                /* -fprofile-values */
  OPT_fprotect_parens = 1444,                /* -fprotect-parens */
  OPT_frandom_seed = 1445,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1446,                  /* -frandom-seed= */
  OPT_frange_check = 1447,                   /* -frange-check */
  OPT_freal_4_real_10 = 1448,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1449,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1450,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1451,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1452,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1453,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1454,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1455,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1456,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1457,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1458,               /* -frecord-marker=8 */
  OPT_frecursive = 1459,                     /* -frecursive */
  OPT_free = 1460,                           /* -free */
  OPT_freg_struct_return = 1461,             /* -freg-struct-return */
  /* OPT_fregmove = 1462, */                 /* -fregmove */
  OPT_frelease = 1463,                       /* -frelease */
  OPT_frename_registers = 1464,              /* -frename-registers */
  OPT_freorder_blocks = 1465,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1466,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1467,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1468,             /* -freorder-functions */
  OPT_frepack_arrays = 1469,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1470,          /* -freplace-objc-classes */
  OPT_frepo = 1471,                          /* -frepo */
  OPT_freport_bug = 1472,                    /* -freport-bug */
  OPT_frequire_return_statement = 1473,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1474,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1475, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1476,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1477,                   /* -fresolution= */
  OPT_frevert_all = 1478,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1479,                /* -frevert=dip1000 */
  ...
  OPT_fset_stack_executable = 1526,          /* -fset-stack-executable */
  ...
  OPT_fwritable_relocated_rdata = 1703,      /* -fwritable-relocated-rdata */
  ...
  OPT_list = 1767,                           /* -list */
  OPT_m128bit_long_double = 1768,            /* -m128bit-long-double */
  OPT_m16 = 1769,                            /* -m16 */
  OPT_m32 = 1770,                            /* -m32 */
  OPT_m3dnow = 1771,                         /* -m3dnow */
  OPT_m3dnowa = 1772,                        /* -m3dnowa */
  OPT_m64 = 1773,                            /* -m64 */
  OPT_m80387 = 1774,                         /* -m80387 */
  OPT_m8bit_idiv = 1775,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1776,             /* -m96bit-long-double */
  OPT_mabi_ = 1777,                          /* -mabi= */
  OPT_mabm = 1778,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1779,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1780,                 /* -maddress-mode= */
  OPT_madx = 1781,                           /* -madx */
  OPT_maes = 1782,                           /* -maes */
  OPT_malign_data_ = 1783,                   /* -malign-data= */
  OPT_malign_double = 1784,                  /* -malign-double */
  OPT_malign_functions_ = 1785,              /* -malign-functions= */
  OPT_malign_jumps_ = 1786,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1787,                  /* -malign-loops= */
  OPT_malign_stringops = 1788,               /* -malign-stringops */
  OPT_mamx_bf16 = 1789,                      /* -mamx-bf16 */
  OPT_mamx_int8 = 1790,                      /* -mamx-int8 */
  OPT_mamx_tile = 1791,                      /* -mamx-tile */
  OPT_march_ = 1792,                         /* -march= */
  OPT_masm_ = 1793,                          /* -masm= */
  OPT_mavx = 1794,                           /* -mavx */
  OPT_mavx2 = 1795,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1796,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1797,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1798,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1799,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1800,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1801,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1802,                      /* -mavx512bw */
  OPT_mavx512cd = 1803,                      /* -mavx512cd */
  OPT_mavx512dq = 1804,                      /* -mavx512dq */
  OPT_mavx512er = 1805,                      /* -mavx512er */
  OPT_mavx512f = 1806,                       /* -mavx512f */
  OPT_mavx512fp16 = 1807,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 1808,                    /* -mavx512ifma */
  OPT_mavx512pf = 1809,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1810,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1811,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1812,                      /* -mavx512vl */
  OPT_mavx512vnni = 1813,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1814,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1815,               /* -mavx512vpopcntdq */
  OPT_mavxvnni = 1816,                       /* -mavxvnni */
  OPT_mbmi = 1817,                           /* -mbmi */
  OPT_mbmi2 = 1818,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1819,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1820,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1821,                    /* -mcet-switch */
  OPT_mcld = 1822,                           /* -mcld */
  OPT_mcldemote = 1823,                      /* -mcldemote */
  OPT_mclflushopt = 1824,                    /* -mclflushopt */
  OPT_mclwb = 1825,                          /* -mclwb */
  OPT_mclzero = 1826,                        /* -mclzero */
  OPT_mcmodel_ = 1827,                       /* -mcmodel= */
  OPT_mconsole = 1828,                       /* -mconsole */
  /* OPT_mcpu_ = 1829, */                    /* -mcpu= */
  OPT_mcrc32 = 1830,                         /* -mcrc32 */
  OPT_mcx16 = 1831,                          /* -mcx16 */
  OPT_mdirect_extern_access = 1832,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 1833,            /* -mdispatch-scheduler */
  OPT_mdll = 1834,                           /* -mdll */
  OPT_mdump_tune_features = 1835,            /* -mdump-tune-features */
  OPT_menqcmd = 1836,                        /* -menqcmd */
  OPT_mf16c = 1837,                          /* -mf16c */
  OPT_mfancy_math_387 = 1838,                /* -mfancy-math-387 */
  OPT_mfentry = 1839,                        /* -mfentry */
  OPT_mfentry_name_ = 1840,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1841,               /* -mfentry-section= */
  OPT_mfma = 1842,                           /* -mfma */
  OPT_mfma4 = 1843,                          /* -mfma4 */
  OPT_mforce_drap = 1844,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1845,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1846,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1847,                       /* -mfpmath= */
  OPT_mfsgsbase = 1848,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1849,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1850, */              /* -mfused-madd */
  OPT_mfxsr = 1851,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1852,             /* -mgeneral-regs-only */
  OPT_mgfni = 1853,                          /* -mgfni */
  OPT_mhard_float = 1854,                    /* -mhard-float */
  OPT_mharden_sls_ = 1855,                   /* -mharden-sls= */
  OPT_mhle = 1856,                           /* -mhle */
  OPT_mhreset = 1857,                        /* -mhreset */
  OPT_miamcu = 1858,                         /* -miamcu */
  OPT_mieee_fp = 1859,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1860,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1861,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1862,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1863,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1864,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1865,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1866,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1867, */            /* -mintel-syntax */
  OPT_mkl = 1868,                            /* -mkl */
  OPT_mlarge_data_threshold_ = 1869,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1870,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1871,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1872,                /* -mlong-double-80 */
  OPT_mlwp = 1873,                           /* -mlwp */
  OPT_mlzcnt = 1874,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1875,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1876,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1877,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1878,                  /* -mmitigate-rop */
  OPT_mmmx = 1879,                           /* -mmmx */
  OPT_mmovbe = 1880,                         /* -mmovbe */
  OPT_mmovdir64b = 1881,                     /* -mmovdir64b */
  OPT_mmovdiri = 1882,                       /* -mmovdiri */
  OPT_mmove_max_ = 1883,                     /* -mmove-max= */
  OPT_mmpx = 1884,                           /* -mmpx */
  OPT_mms_bitfields = 1885,                  /* -mms-bitfields */
  OPT_mmwait = 1886,                         /* -mmwait */
  OPT_mmwaitx = 1887,                        /* -mmwaitx */
  OPT_mneeded = 1888,                        /* -mneeded */
  OPT_mno_align_stringops = 1889,            /* -mno-align-stringops */
  OPT_mno_default = 1890,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1891,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1892,                  /* -mno-push-args */
  OPT_mno_red_zone = 1893,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1894,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 1895,             /* -mnop-fun-dllimport */
  OPT_mnop_mcount = 1896,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1897,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1898,                          /* -mpc32 */
  OPT_mpc64 = 1899,                          /* -mpc64 */
  OPT_mpc80 = 1900,                          /* -mpc80 */
  OPT_mpclmul = 1901,                        /* -mpclmul */
  OPT_mpcommit = 1902,                       /* -mpcommit */
  OPT_mpconfig = 1903,                       /* -mpconfig */
  OPT_mpe_aligned_commons = 1904,            /* -mpe-aligned-commons */
  OPT_mpku = 1905,                           /* -mpku */
  OPT_mpopcnt = 1906,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1907, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1908,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1909,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1910,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1911,                        /* -mprfchw */
  OPT_mptwrite = 1912,                       /* -mptwrite */
  OPT_mpush_args = 1913,                     /* -mpush-args */
  OPT_mrdpid = 1914,                         /* -mrdpid */
  OPT_mrdrnd = 1915,                         /* -mrdrnd */
  OPT_mrdseed = 1916,                        /* -mrdseed */
  OPT_mrecip = 1917,                         /* -mrecip */
  OPT_mrecip_ = 1918,                        /* -mrecip= */
  OPT_mrecord_mcount = 1919,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1920,                 /* -mrecord-return */
  OPT_mred_zone = 1921,                      /* -mred-zone */
  OPT_mregparm_ = 1922,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 1923,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 1924,                           /* -mrtd */
  OPT_mrtm = 1925,                           /* -mrtm */
  OPT_msahf = 1926,                          /* -msahf */
  OPT_mserialize = 1927,                     /* -mserialize */
  OPT_msgx = 1928,                           /* -msgx */
  OPT_msha = 1929,                           /* -msha */
  OPT_mshstk = 1930,                         /* -mshstk */
  OPT_mskip_rax_setup = 1931,                /* -mskip-rax-setup */
  OPT_msoft_float = 1932,                    /* -msoft-float */
  OPT_msse = 1933,                           /* -msse */
  OPT_msse2 = 1934,                          /* -msse2 */
  OPT_msse2avx = 1935,                       /* -msse2avx */
  OPT_msse3 = 1936,                          /* -msse3 */
  OPT_msse4 = 1937,                          /* -msse4 */
  OPT_msse4_1 = 1938,                        /* -msse4.1 */
  OPT_msse4_2 = 1939,                        /* -msse4.2 */
  OPT_msse4a = 1940,                         /* -msse4a */
  /* OPT_msse5 = 1941, */                    /* -msse5 */
  OPT_msseregparm = 1942,                    /* -msseregparm */
  OPT_mssse3 = 1943,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1944,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1945, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1946,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1947, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1948,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1949,                  /* -mstackrealign */
  OPT_mstore_max_ = 1950,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 1951,            /* -mstringop-strategy= */
  OPT_mstv = 1952,                           /* -mstv */
  OPT_mtbm = 1953,                           /* -mtbm */
  OPT_mthreads = 1954,                       /* -mthreads */
  OPT_mtls_dialect_ = 1955,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1956,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1957,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1958,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1959,                         /* -mtune= */
  OPT_muintr = 1960,                         /* -muintr */
  OPT_municode = 1961,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1962,          /* -muse-libstdc-wrappers */
  OPT_mvaes = 1963,                          /* -mvaes */
  OPT_mveclibabi_ = 1964,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1965,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1966,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1967,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1968,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1969,                      /* -mwbnoinvd */
  OPT_mwidekl = 1970,                        /* -mwidekl */
  OPT_mwin32 = 1971,                         /* -mwin32 */
  OPT_mwindows = 1972,                       /* -mwindows */
  OPT_mx32 = 1973,                           /* -mx32 */
  OPT_mxop = 1974,                           /* -mxop */
  OPT_mxsave = 1975,                         /* -mxsave */
  OPT_mxsavec = 1976,                        /* -mxsavec */
  OPT_mxsaveopt = 1977,                      /* -mxsaveopt */
  OPT_mxsaves = 1978,                        /* -mxsaves */
  OPT_n = 1979,                              /* -n */
  OPT_name_sort = 1980,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1981,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1982,              /* -no-integrated-cpp */
  OPT_no_pie = 1983,                         /* -no-pie */
  OPT_no_pthread = 1984,                     /* -no-pthread */
  OPT_nocpp = 1985,                          /* -nocpp */
  OPT_nodefaultlibs = 1986,                  /* -nodefaultlibs */
  OPT_nolibc = 1987,                         /* -nolibc */
  OPT_nophoboslib = 1988,                    /* -nophoboslib */
  OPT_nostartfiles = 1989,                   /* -nostartfiles */
  OPT_nostdinc = 1990,                       /* -nostdinc */
  OPT_nostdinc__ = 1991,                     /* -nostdinc++ */
  OPT_nostdlib = 1992,                       /* -nostdlib */
  OPT_o = 1993,                              /* -o */
  OPT_objects = 1994,                        /* -objects */
  OPT_p = 1995,                              /* -p */
  OPT_pass_exit_codes = 1996,                /* -pass-exit-codes */
  /* OPT_pedantic = 1997, */                 /* -pedantic */
  OPT_pedantic_errors = 1998,                /* -pedantic-errors */
  OPT_pg = 1999,                             /* -pg */
  OPT_pie = 2000,                            /* -pie */
  OPT_pipe = 2001,                           /* -pipe */
  OPT_posix = 2002,                          /* -posix */
  OPT_print_file_name_ = 2003,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2004,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2005,          /* -print-multi-directory */
  OPT_print_multi_lib = 2006,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2007,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2008,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2009,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2010,               /* -print-prog-name= */
  OPT_print_search_dirs = 2011,              /* -print-search-dirs */
  OPT_print_sysroot = 2012,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2013,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2014,                    /* -print-value */
  OPT_pthread = 2015,                        /* -pthread */
  OPT_quiet = 2016,                          /* -quiet */
  OPT_r = 2017,                              /* -r */
  OPT_remap = 2018,                          /* -remap */
  OPT_reverse_sort = 2019,                   /* -reverse-sort */
  OPT_s = 2020,                              /* -s */
  OPT_save_temps = 2021,                     /* -save-temps */
  OPT_save_temps_ = 2022,                    /* -save-temps= */
  OPT_shared = 2023,                         /* -shared */
  OPT_shared_libgcc = 2024,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2025,               /* -shared-libphobos */
  OPT_size_sort = 2026,                      /* -size-sort */
  /* OPT_specs = 2027, */                    /* -specs */
  OPT_specs_ = 2028,                         /* -specs= */
  OPT_static = 2029,                         /* -static */
  OPT_static_libasan = 2030,                 /* -static-libasan */
  OPT_static_libgcc = 2031,                  /* -static-libgcc */
  OPT_static_libgfortran = 2032,             /* -static-libgfortran */
  OPT_static_libgo = 2033,                   /* -static-libgo */
  OPT_static_libhwasan = 2034,               /* -static-libhwasan */
  OPT_static_liblsan = 2035,                 /* -static-liblsan */
  OPT_static_libmpx = 2036,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2037,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2038,               /* -static-libphobos */
  OPT_static_libstdc__ = 2039,               /* -static-libstdc++ */
  OPT_static_libtsan = 2040,                 /* -static-libtsan */
  OPT_static_libubsan = 2041,                /* -static-libubsan */
  OPT_static_pie = 2042,                     /* -static-pie */
  /* OPT_std_c__03 = 2043, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2044, */                /* -std=c++0x */
  OPT_std_c__11 = 2045,                      /* -std=c++11 */
  OPT_std_c__14 = 2046,                      /* -std=c++14 */
  OPT_std_c__17 = 2047,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2048, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2049, */                /* -std=c++1z */
  OPT_std_c__20 = 2050,                      /* -std=c++20 */
  OPT_std_c__23 = 2051,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2052, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2053, */                /* -std=c++2b */
  OPT_std_c__98 = 2054,                      /* -std=c++98 */
  OPT_std_c11 = 2055,                        /* -std=c11 */
  OPT_std_c17 = 2056,                        /* -std=c17 */
  /* OPT_std_c18 = 2057, */                  /* -std=c18 */
  /* OPT_std_c1x = 2058, */                  /* -std=c1x */
  OPT_std_c2x = 2059,                        /* -std=c2x */
  /* OPT_std_c89 = 2060, */                  /* -std=c89 */
  OPT_std_c90 = 2061,                        /* -std=c90 */
  OPT_std_c99 = 2062,                        /* -std=c99 */
  /* OPT_std_c9x = 2063, */                  /* -std=c9x */
  OPT_std_f2003 = 2064,                      /* -std=f2003 */
  OPT_std_f2008 = 2065,                      /* -std=f2008 */
  OPT_std_f2008ts = 2066,                    /* -std=f2008ts */
  OPT_std_f2018 = 2067,                      /* -std=f2018 */
  OPT_std_f95 = 2068,                        /* -std=f95 */
  OPT_std_gnu = 2069,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2070, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2071, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2072,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2073,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2074,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2075, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2076, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2077,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2078,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2079, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2080, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2081,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2082,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2083,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2084, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2085, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2086,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2087, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2088,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2089,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2090, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2091, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2092,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2093, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2094, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2095, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2096, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2097, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2098,                     /* -std=legacy */
  OPT_stdlib_ = 2099,                        /* -stdlib= */
  OPT_symbol_ = 2100,                        /* -symbol= */
  OPT_symbolic = 2101,                       /* -symbolic */
  OPT_t = 2102,                              /* -t */
  OPT_time = 2103,                           /* -time */
  OPT_time_ = 2104,                          /* -time= */
  OPT_traditional = 2105,                    /* -traditional */
  OPT_traditional_cpp = 2106,                /* -traditional-cpp */
  OPT_tree_stats = 2107,                     /* -tree-stats */
  OPT_trigraphs = 2108,                      /* -trigraphs */
  OPT_type_stats = 2109,                     /* -type-stats */
  OPT_u = 2110,                              /* -u */
  OPT_undef = 2111,                          /* -undef */
  OPT_v = 2112,                              /* -v */
  OPT_version = 2113,                        /* -version */
  OPT_w = 2114,                              /* -w */
  OPT_wrapper = 2115,                        /* -wrapper */
  OPT_x = 2116,                              /* -x */
  OPT_z = 2117,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
